...
**ContainsCity** | **bool** | True if the document contains standalone city names (e.g. \&quot;San Francisco\&quot;) outside of a full street address. | [optional] 
...
**ContainsMedicalRecordNumber** | **bool** | True if the document contains medical record numbers. | [optional] 
**ContainsBillingAccountNumber** | **bool** | True if the document contains billing account numbers (provider/customer billing account IDs, distinct from bank account numbers). | [optional] 
