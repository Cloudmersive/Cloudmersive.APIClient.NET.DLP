...
namespace Cloudmersive.APIClient.NET.DLP.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DlpAdvancedAudioRedactionResponse")]
    public partial class DlpAdvancedAudioRedactionResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DlpAdvancedAudioRedactionResponse" /> class.
        /// </summary>
        /// <param name="redactedAudio">The redacted audio file bytes with PII segments bleeped or muted, or the original audio if no disallowed PII was found..</param>
        /// <param name="redactedTranscript">The redacted transcript text with PII removed or replaced..</param>
        /// <param name="originalTranscript">Full original transcript of the audio file..</param>
        /// <param name="timestamps">Token-level timestamps from speech recognition..</param>
        /// <param name="redactedSegments">List of audio segments that were redacted, with their time ranges..</param>
        ...
        /// </summary>
        /// <value>The redacted audio file bytes with PII segments bleeped or muted, or the original audio if no disallowed PII was found.</value>
        [DataMember(Name = "RedactedAudio", EmitDefaultValue = false)]
        public byte[] RedactedAudio { get; set; }

        /// <summary>
        /// The redacted transcript text with PII removed or replaced.
        /// </summary>
        /// <value>The redacted transcript text with PII removed or replaced.</value>
        [DataMember(Name = "RedactedTranscript", EmitDefaultValue = false)]
        public string RedactedTranscript { get; set; }

        /// <summary>
        /// Full original transcript of the audio file.
        /// </summary>
        /// <value>Full original transcript of the audio file.</value>
        [DataMember(Name = "OriginalTranscript", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>List of audio segments that were redacted, with their time ranges.</value>
        [DataMember(Name = "RedactedSegments", EmitDefaultValue = false)]
        public List<RedactedAudioSegment> RedactedSegments { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DlpAdvancedAudioRedactionResponse {\n");
            sb.Append("  RedactedAudio: ").Append(RedactedAudio).Append("\n");
            sb.Append("  RedactedTranscript: ").Append(RedactedTranscript).Append("\n");
            sb.Append("  OriginalTranscript: ").Append(OriginalTranscript).Append("\n");
            sb.Append("  Timestamps: ").Append(Timestamps).Append("\n");
            sb.Append("  RedactedSegments: ").Append(RedactedSegments).Append("\n");
